var cfg ={
				...
				$('#saveAndNext').on('click', function() {
					  ...
					  {
					  		$.ajax({url:"config/CaptureBoard.php",data:{Question:question,BoardPosition:JSON.stringify(boardPositionNew),Level:level,FirstMove:firstMove}}).done(function(data){
