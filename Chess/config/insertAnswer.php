<?php
	...
	$mover = filter_input(INPUT_GET,'mover'); 
...
for ($i=0;$i<count($userMove);$i++ ) {
	...
	$query = "insert into puzzle_answer values('$level','$chapter','$subChapter',0,'$problem','$moveId','$answerId','$currentUserMove','$currentAdminMove','$mover')";
